              ...
              <Row>
                <Col>
                  ...
                  <Modal
                    ...
                    toggle={() => {
                      this.setState({
                        isGenerateModal: !this.state.isGenerateModal,
                      });
                    }}
                  >
                    <Form method='POST' onSubmit={this.onSubmitGenerator}>
                      <ModalHeader>{`Re-Generation`}</ModalHeader>
                      <ModalBody>
                        {responseErrors && (
                          <UncontrolledAlert color='warning'>
                            <span className='alert-text ml-1'>
                        ...
                        <FormGroup>
                          <CustomInput
                            ...
                            defaultChecked
                            onChange={() =>
                              this.setState({ genOption: 'image_only' })
                            }
                          />
                          <CustomInput
                            id="print_only"
                            ...
                            label="Print Files"
                            onChange={() =>
                              this.setState({ genOption: 'print_only' })
                            }
                          />
                          <CustomInput
                            id="both_image_print"
                            type="radio"
                            name="customRadio"
                            label="Both Image, Print Files"
                            onChange={() =>
                              this.setState({ genOption: 'both_image_print' })
                            }
                          />
                        </FormGroup>
                      </ModalBody>
                      <ModalFooter>
                        <Button
                          color='secondary'
                          onClick={(e) => {
                            this.setState({ isGenerateModal: false });
                          }}
                        >
                          {`Cancel`}
                        </Button>
