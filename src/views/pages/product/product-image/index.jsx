...
import ImageThemeDoubleSection from './image-theme-double-section';
import ImageThemeSingleSection from './image-theme-single-section';
import ImageSideDoubleSection from './image-side-double-section';
import ImageStickersSection from './image-stickers-section';
                ...
                <Row>
                    {Object.keys(source).map(item => (
                        <React.Fragment key={item}>
                            ...
                            {source[item].type === 1 &&
                                <Col md={5}>
                                    <ImageThemeSingleSection source={source[item]} />
                                </Col>
                            }
                            {source[item].type === 3 &&
                                <Col md={7}>
                                    <ImageSideDoubleSection
                                        source={source[item]}
                                        skuNumber={skuNumber}
                                        themeUrl={themeUrl}
                                        variant={item}
