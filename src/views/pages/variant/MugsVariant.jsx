...
class MugVariant extends React.Component {
  ...
  handleEdit(id) {
    ...
    this.setState({ modalMug: { ...mug }, isModal: true, responseErrors: "", errors: {} });
  }
  ...
  handleDelete(id) {
    ...
    this.setState({ modalMug: { ...mug }, isDeleteModal: true, responseErrors: "" });
  }
        ...
        return (
          <tr key={data.id}>
            ...
            <td className="td-action">
              <Row>
                <Col md={12} xl={12}>
                  <Button className="btn-tbl-mugvariant-edit" size="sm" color="primary" data-dz-remove onClick={e => {
                  ...
                  <Button className="btn-tbl-mugvariant-delete" size="sm" color="warning" data-dz-remove onClick={e => {
  ...
  createMug() {
    ...
    this.state.colors.map(item => {
      if (item.key === modalMug.color) colorstring = item.name;
    });
    this.state.sizes.map(item => {
      if (item.key === modalMug.size) sizestring = item.name;
    });
    this.state.types.map(item => {
      if (item.key === modalMug.type) typestring = item.name;
    });
    modalMug['id'] = 0;
    modalMug['name'] = colorstring + " " + typestring;
              ...
              <Row>
                <Col>
                  ...
                  >
                    ...
                    >
                      <ModalHeader color="primary">Mugs Variant Edit</ModalHeader>
                      <ModalBody>
                        {responseErrors && (
                          <UncontrolledAlert color="warning">
                            <span className="alert-text ml-1">
