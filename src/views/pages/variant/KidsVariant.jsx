...
class KidVariant extends React.Component {
    ...
    if (nextProps.types) {
      if (nextProps.types.length > 0) {
        this.setState({ types: nextProps.types }, function () {
          modalKid['type'] = this.state.types[0].key;
        });
      }
    }
  ...
  handleEdit(id) {
    ...
    this.setState({ modalKid: { ...kid }, isModal: true, responseErrors: "", errors: {} });
  }
  ...
  handleDelete(id) {
    ...
    this.setState({ modalKid: { ...kid }, isDeleteModal: true, responseErrors: "" });
  }
        ...
        return (
          <tr key={data.id}>
            ...
            <td className="td-action">
              <Row>
                <Col md={12} xl={12}>
                  <Button className="btn-tbl-kidvariant-edit" size="sm" color="primary" data-dz-remove onClick={e => {
                  ...
                  <Button className="btn-tbl-kidvariant-delete" size="sm" color="warning" data-dz-remove onClick={e => {
  ...
  createKid() {
    ...
    this.state.colors.map(item => {
      if (item.key === modalKid.color) colorstring = item.name;
    });
    this.state.sizes.map(item => {
      if (item.key === modalKid.size) sizestring = item.name;
    });
    modalKid['id'] = 0;
    modalKid['name'] = colorstring + " " + sizestring;
              ...
              <Row>
                <Col>
                  ...
                  >
                    ...
                    >
                      <ModalHeader color="primary">Kids Variant Edit</ModalHeader>
                      <ModalBody>
                        {responseErrors && (
                          <UncontrolledAlert color="warning">
                            <span className="alert-text ml-1">
