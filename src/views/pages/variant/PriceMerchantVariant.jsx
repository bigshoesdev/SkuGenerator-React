...
class PriceMarchantVariant extends React.Component {
    constructor(props) {
        super(props);
        this.refPriceVars = {};
        this.state = {
        ...
        if (nextProps.prices) {
            if (nextProps.prices.length > 0) {
                ...
                nextProps.prices.map((price) => {
                    switch (price.master) {
                        case 'tshirts':
                            data.tshirts = [price.australia_price, price.canada_price, price.usa_price, price.europe_price, price.uk_price];
                            break;
                        case 'stickers':
                            data.stickers = [price.australia_price, price.canada_price, price.usa_price, price.europe_price, price.uk_price];
                            break;
                        case 'mugs':
                            data.mugs = [price.australia_price, price.canada_price, price.usa_price, price.europe_price, price.uk_price];
                            break;
                        case 'toteBags':
                            data.toteBags = [price.australia_price, price.canada_price, price.usa_price, price.europe_price, price.uk_price];
                            break;
                        case 'cushionCovers':
                            data.cushionCovers = [price.australia_price, price.canada_price, price.usa_price, price.europe_price, price.uk_price];
                            break;
                        case 'kids':
                            data.kids = [price.australia_price, price.canada_price, price.usa_price, price.europe_price, price.uk_price];
                            break;
                        case 'hoodies':
                            data.hoodies = [price.australia_price, price.canada_price, price.usa_price, price.europe_price, price.uk_price];
                            break;
                    }
                });
